...
public class Main {
    ...
    public static void driverFunc() {
        Util.print("Initializing driver function...");
        Util.print();
        ...
        try{
            ...
            street.removeArchitectureAt(1, Side.Left);
        ...
        try{
            ...
            street.removeArchitectureAt(-1, Side.Right);
        } catch (ArrayIndexOutOfBoundsException e){
            Util.print(e.getMessage());
        ...
        try{
            ...
            street.removeArchitectureAt(0, Side.Right);
    ...
    public static void streetCreation() {
        ...
        try{
            street = new Street(readIntGreater(-1));
        }
    ...
    public static void removeArchitectureMenu() {
        while (true){
            ...
            if(input == 0) return;
                ...
                try{
                    street.removeArchitectureAt(index, side);
                    Util.print("Removed!");
                }
                // If entered index is out of range, inform the user
                catch (ArrayIndexOutOfBoundsException e) {
     ...
     * @throws Street.InvalidPositionException  When position of the architecture is outside
     *                                          the street
     * @throws Street.PositionOccupiedException When another architecture is in the way
     * @throws Street.NotEnoughSpaceException   When architecture doesn't fit in the street
     */
    public static void addArchitecture(Architecture architecture) throws Street.InvalidPositionException, Street.PositionOccupiedException, Street.NotEnoughSpaceException {
        Side side = readSide();
    ...
    public static int addOffice() {
        ...
        while(true){
            while(true){
                ...
                try {
                    newOffice = new Office(position, length, height, owner, Util.separateString(jobTypes, '|'));
                    break;
                }
                catch (InvalidAttributeValueException e){
                    Util.print(e.getMessage());
